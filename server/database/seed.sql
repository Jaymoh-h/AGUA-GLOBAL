...
VALUES
  ((SELECT id FROM customers WHERE acc_number = 'AG-0001'), 120, '2026-04-01', (SELECT id FROM users WHERE email = 'reader@agua.local')),
  ((SELECT id FROM customers WHERE acc_number = 'AG-0001'), 148, '2026-05-01', (SELECT id FROM users WHERE email = 'reader@agua.local')),
  ((SELECT id FROM customers WHERE acc_number = 'AG-0002'), 500, '2026-04-01', (SELECT id FROM users WHERE email = 'reader@agua.local')),
  ((SELECT id FROM customers WHERE acc_number = 'AG-0002'), 535, '2026-05-01', (SELECT id FROM users WHERE email = 'reader@agua.local')),
  ((SELECT id FROM customers WHERE acc_number = 'AG-0003'), 990, '2026-04-01', (SELECT id FROM users WHERE email = 'reader@agua.local')),
  ((SELECT id FROM customers WHERE acc_number = 'AG-0003'), 1048, '2026-05-01', (SELECT id FROM users WHERE email = 'reader@agua.local'));

INSERT INTO bills (
  customer_id, previous_reading_id, current_reading_id, billing_month,
  previous_reading, current_reading, units_used, rate, amount, paid_amount, status, due_date, paid_at
)
VALUES
  (
    ...
    '2026-05-01', 120, 148, 28, 75, 2100, 1000, 'partial', '2026-05-15', NULL
  ),
  (
    ...
    '2026-05-01', 500, 535, 35, 85, 2975, 0, 'unpaid', '2026-05-15', NULL
  ),
  (
    ...
    '2026-05-01', 990, 1048, 58, 70, 4060, 4060, 'paid', '2026-05-15', NOW()
  );

INSERT INTO payments (customer_id, bill_id, amount, payment_date, method, reference, recorded_by)
VALUES
  (
    (SELECT id FROM customers WHERE acc_number = 'AG-0001'),
    (SELECT id FROM bills WHERE customer_id = (SELECT id FROM customers WHERE acc_number = 'AG-0001') AND billing_month = '2026-05-01'),
    1000, '2026-05-08', 'mobile_money', 'MPESA-DEMO-001', (SELECT id FROM users WHERE email = 'accountant@agua.local')
  ),
  (
    (SELECT id FROM customers WHERE acc_number = 'AG-0003'),
    (SELECT id FROM bills WHERE customer_id = (SELECT id FROM customers WHERE acc_number = 'AG-0003') AND billing_month = '2026-05-01'),
    4060, '2026-05-09', 'bank', 'BANK-DEMO-003', (SELECT id FROM users WHERE email = 'accountant@agua.local')
  );
